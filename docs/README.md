...
- `product/DOMAIN_GLOSSARY.md`: canonical vocabulary for product, runtime, and generation concepts.
- `product/DELIVERY_ROADMAP.md`: step by step construction roadmap.

## Architecture
- `architecture/PRINCIPLES.md`: architecture principles and quality attributes.
